  ...
  public async getStatus(): Promise<PollerStatus> {
    ...
    try {
      ...
      return {
        ...
        activeTokens: typeof data.activeTokens === 'number' ? data.activeTokens : (typeof data.totalTokens === 'number' ? data.totalTokens : 0),
        revokedTokens: typeof data.revokedTokens === 'number' ? data.revokedTokens : 0,
        unsubscribedTokens: typeof data.unsubscribedTokens === 'number' ? data.unsubscribedTokens : 0,
        iosTokens: typeof data.iosTokens === 'number' ? data.iosTokens : 0,
        androidTokens: typeof data.androidTokens === 'number' ? data.androidTokens : 0,
        pwaTokens: typeof data.pwaTokens === 'number' ? data.pwaTokens : 0,

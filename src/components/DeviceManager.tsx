          ...
          <>
            ...
            <div className="md:hidden divide-y divide-slate-100 dark:divide-[#27272a]">
              {filteredDevices.map((dev, idx) => {
                ...
                return (
                  <div key={dev.token || idx} className="p-3.5 space-y-2.5">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        {isActive && (
                          <span title="Active & Protected" className="text-emerald-500 shrink-0">
                    ...
                    {/* Metadata: Platform & Registered Date */}
                    <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-zinc-400">
                      <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold uppercase bg-slate-100 text-slate-700 dark:bg-zinc-800 dark:text-zinc-300">
                    ...
                    {/* Token & Actions Row */}
                    <div className="flex items-center justify-between gap-2 pt-1 border-t border-slate-50 dark:border-[#202023]">
                      <code
                        onClick={() => handleCopy(dev.token)}
                        className="text-[10px] font-mono text-slate-600 dark:text-zinc-300 bg-slate-100 dark:bg-zinc-900 px-2 py-1 rounded truncate max-w-[130px] sm:max-w-[200px] cursor-pointer hover:bg-slate-200 dark:hover:bg-zinc-800 transition-colors"
                        title="Tap to copy token"
                      >
                        {dev.token}
                      </code>
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          onClick={() => handleCopy(dev.token)}
                          className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-slate-600 dark:text-zinc-300"
                          title="Copy Token"
                        >
                        ...
                        {!isActive && (
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/60 text-rose-600 dark:text-rose-400"

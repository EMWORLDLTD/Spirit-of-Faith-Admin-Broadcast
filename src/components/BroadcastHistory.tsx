    ...
    <div className="space-y-4 sm:space-y-5">
        ...
        <button
          ...
          className={`flex-1 py-2 px-3 rounded-xl text-xs font-semibold transition-all flex items-center justify-center gap-1.5 ${
            activeTab === 'dispatches'
              ? 'bg-white dark:bg-[#18181b] text-slate-900 dark:text-zinc-100 border border-slate-200 dark:border-[#27272a]'
      ...
      {activeTab === 'dispatches' ? (
              ...
              {filteredHistory.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#18181b] border border-slate-200 dark:border-[#27272a] flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                  >
                    {/* Left: Icon & Content */}
        ...
        <div className="space-y-4">
          <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-[#18181b] border border-slate-200 dark:border-[#27272a] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <h2 className="font-outfit font-bold text-base sm:text-lg text-slate-900 dark:text-zinc-100">
      ...
      {inspectPayloadItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="w-full max-w-md bg-white dark:bg-[#18181b] border border-slate-200 dark:border-[#27272a] rounded-2xl p-4 text-xs space-y-3">
